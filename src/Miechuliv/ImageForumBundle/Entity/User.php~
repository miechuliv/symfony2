...
class User implements UserInterface, \Serializable
{
     ...
     * Add roles
     *
     * @param \Miechuliv\ImageForumBundle\Entity\Role $roles
     * @return User
     */
    public function addRole(\Miechuliv\ImageForumBundle\Entity\Role $roles)
    {
        $this->roles[] = $roles;
     ...
     * @param \Miechuliv\ImageForumBundle\Entity\Role $roles
     */
    public function removeRole(\Miechuliv\ImageForumBundle\Entity\Role $roles)
    {
